...
export default function Uploaded() {
  ...
  if (loading) {
    return <div className={styles.no_data_uploaded}>Loading...</div>;
  }

  if (docs.length === 0) {
    return <div className={styles.no_data_uploaded}>No data to display</div>;
  }
  ...
  return (
    <div className={styles.uploaded_page_content}>
