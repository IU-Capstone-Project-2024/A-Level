...
export default function Uploaded() {
  ...
  async function getDocs(page: number, length: number) {
    const res = await axios.get('https://chartreuse-binghamite1373.my-vm.work/document', {
      params: {
        offset: page - 1,
        length: length,
      },
  ...
  useEffect(() => {
    async function fetchDocs() {
      ...
      const totalDoc = await axios.get('https://chartreuse-binghamite1373.my-vm.work/document/number');
