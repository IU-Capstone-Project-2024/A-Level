  ...
  async function onSubmitHandler() {
    ...
    try {
      const response: AxiosResponse<DocumentProps> = await axios.post(
        'https://203.31.40.71:8000/document/upload',
        formData,
      );
      if (response.status === 200) {
        ...
        const responseImg: AxiosResponse<DocumentProps> = await axios.post(
          `https://203.31.40.71:8000/document/${response.data._id}/img`,
          formData,
        );
  ...
  return (
    <div className="browsing-main">
      <div className="browsing-page">
        ...
        {browsed && (
          <div className="uploaded-container">
            ...
            {imageSrc && (
              <img className="pdf-preview" src={imageSrc} alt="PDF preview" />
            )}
          </div>
        )}
      </div>
      <div className="submit-container">
        ...
        <button
          className={'submit-button ' + (browsed ? 'enabled' : 'disabled')}
